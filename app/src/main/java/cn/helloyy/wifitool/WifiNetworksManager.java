...
import cn.helloyy.wifitool.services.SaveWifiNetworkService;
...
//            }
    ...
    public List<WiFiApConfig> getSortedWifiApConfigsList() {
        ...
        synchronized (wifiNetworkStatusLock) {
            ...
            try {
                ...
                Timber.e(e, configListToDBG().toString());
    ...
    public Observable<List<WiFiApConfig>> getSortedWifiApConfigsList2() {

        Observable<List<WiFiApConfig>> observable = Observable.create(new Observable.OnSubscribe<List<WiFiApConfig>>() {
            @Override
            public void call(Subscriber<? super List<WiFiApConfig>> subscriber) {
                List<WiFiApConfig> wifiApConfigs = WifiNetworksManager.this.getSortedWifiApConfigsList();
                subscriber.onNext(wifiApConfigs);
